...
function(add_dependency_local ARG_LOCAL_NAME)
    ...
    if (Git_FOUND AND NOT ${ARG_LOCAL_NAME}_FOUND)
        ...
        execute_process(COMMAND ${GIT_EXECUTABLE} submodule update --init dependencies/${ARG_LOCAL_NAME} WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} RESULT_VARIABLE ${ARG_LOCAL_NAME}_SUBMODULE_RESULT)
    ...
    # check for git failure and include the sub module directory on success
    if(${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0")
        message(STATUS "${ARG_LOCAL_NAME} git sub module successfully initialised")
    elseif(NOT ${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0" AND NOT ${ARG_LOCAL_NAME}_FOUND AND Git_FOUND)
    ...
    endif(${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0")
...
function(add_dependency_remote ARG_LOCAL_NAME)
    ...
    if(${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0")
        message(STATUS "${ARG_LOCAL_NAME} git sub module successfully initialised")
    elseif(NOT ${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0" AND Git_FOUND)
        message(WARNING "Initialisation of the ${ARG_LOCAL_NAME} sub module failed! Please check if your git installation is working correctly")
    endif(${ARG_LOCAL_NAME}_SUBMODULE_RESULT EQUAL "0")
